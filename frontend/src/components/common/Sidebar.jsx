...
const Sidebar = () => {
  ...
  const salesItems = [
    ...
    { path: "/sales/policy", label: "Incentive Policies", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
  ...
  // SIMPLIFIED ADMIN NAVIGATION - Only 8 Core Items
  const adminItems = [
    ...
    { path: "/admin/deals", label: "Deal Management", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
    ...
    { path: "/admin/policy", label: "Policies", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
      ...
      <nav className="flex-1 px-4 space-y-2">
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center space-x-3 px-4 py-3 text-sm font-medium rounded-xl transition-all ${isActive
